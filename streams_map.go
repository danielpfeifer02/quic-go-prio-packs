...
func (m *streamsMap) OpenStreamWithPriority(priority priority_setting.Priority) (Stream, error) {
...
// PRIO_PACKS_TAG
// OpenStream wrapper for priority setting
func (m *streamsMap) OpenStreamSyncWithPriority(ctx context.Context, priority priority_setting.Priority) (Stream, error) {
...
// PRIO_PACKS_TAG
// OpenStream wrapper for priority setting
func (m *streamsMap) OpenUniStreamWithPriority(priority priority_setting.Priority) (SendStream, error) {
...
// PRIO_PACKS_TAG
// OpenStream wrapper for priority setting
func (m *streamsMap) OpenUniStreamSyncWithPriority(ctx context.Context, priority priority_setting.Priority) (SendStream, error) {
...
// PRIO_PACKS_TAG
func (m *streamsMap) GetPriority(id protocol.StreamID) priority_setting.Priority {
	str, err := m.getOrOpenSendStream(id)
	if err != nil {
